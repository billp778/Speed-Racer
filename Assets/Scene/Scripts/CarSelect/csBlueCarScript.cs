...
public class csBlueCarScript : MonoBehaviour {
	...
	void Start () {
        ...
        this.gameObject.AddComponent<ClickActionBlue>();

        this.GetComponent<ClickActionBlue>().setPanels(this.carPanelGrey, this.carPanelRed,
    ...
    void initialize()
    {
        ...
        reader.Read();
        if (!reader["name"].Equals("CAR_BLUE"))
        {
...
public class ClickActionBlue : MonoBehaviour, IPointerClickHandler
{
    ...
    public void OnPointerClick(PointerEventData eventData)
    {
        ...
        this.carDesc.text = "A Car with a BLUE body";
