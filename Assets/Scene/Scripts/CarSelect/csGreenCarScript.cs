...
public class csGreenCarScript : MonoBehaviour {
	...
	void Start () {
        ...
        this.gameObject.AddComponent<ClickActionGreen>();

        this.GetComponent<ClickActionGreen>().setPanels(this.carPanelGrey, this.carPanelRed,
    ...
    void initialize() {
        ...
        reader.Read();
        if (!reader["name"].Equals("CAR_GREEN")) {
...
public class ClickActionGreen : MonoBehaviour, IPointerClickHandler
{
    ...
    public void OnPointerClick(PointerEventData eventData)
    {
        ...
        this.carDesc.text = "A Car with a GREEN body";
